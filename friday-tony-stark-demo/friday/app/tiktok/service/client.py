"""Low-level client for TikTok operations."""
...
from friday.app.tiktok.utils.helpers import build_resource_url, normalize_identifier


class TikTokClient:
    """Thin client that prepares low-level payloads for TikTok."""
    ...
    def get_profile(self, request: GetProfileRequest) -> dict[str, object]:
        ...
        return {
            ...
            "label": f"TikTok Profile {identifier}",
    ...
    def get_post_detail(self, request: GetPostDetailRequest) -> dict[str, object]:
        ...
        return {
            ...
            "label": f"TikTok Video {content_id}",
    ...
    def publish_content(self, request: PublishContentRequest) -> dict[str, object]:
        ...
        return {
            ...
            "label": request.title or f"TikTok Draft",

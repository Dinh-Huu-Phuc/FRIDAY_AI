...
class PinterestMapper:
    """Map Pinterest domain entities into outward-facing responses."""
    ...
    def to_profile_response(self, entity: PinterestProfileEntity) -> ProfileResponse:
    ...
    def to_detail_response(self, entity: PinterestPinEntity) -> ContentDetailResponse:
        return ContentDetailResponse(platform=self.platform_name, item=entity)

    def to_publish_response(self, entity: PinterestPinEntity) -> PublishContentResponse:

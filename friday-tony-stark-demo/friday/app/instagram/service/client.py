"""Low-level client for Instagram operations."""
...
from friday.app.instagram.utils.helpers import build_resource_url, normalize_identifier


class InstagramClient:
    """Thin client that prepares low-level payloads for Instagram."""
    ...
    def get_profile(self, request: GetProfileRequest) -> dict[str, object]:
        ...
        return {
            ...
            "label": f"Instagram Profile {identifier}",
    ...
    def get_post_detail(self, request: GetPostDetailRequest) -> dict[str, object]:
        ...
        return {
            ...
            "label": f"Instagram Post {content_id}",
    ...
    def publish_content(self, request: PublishContentRequest) -> dict[str, object]:
        ...
        return {
            ...
            "label": request.title or f"Instagram Draft",

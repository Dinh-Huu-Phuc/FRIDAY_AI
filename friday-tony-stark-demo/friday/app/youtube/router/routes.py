"""Command handlers and route-style entrypoints for YouTube."""

from friday.app.common.messages import UNKNOWN_PLATFORM_MESSAGE
from friday.app.youtube.constants import PLATFORM_ALIASES, PLATFORM_NAME
...
from friday.app.youtube.utils.helpers import matches_platform_command
...
def get_profile(
    ...
    active_service = service or get_youtube_service()

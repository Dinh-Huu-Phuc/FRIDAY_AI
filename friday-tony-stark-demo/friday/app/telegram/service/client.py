"""Low-level client for Telegram operations."""
...
from friday.app.telegram.utils.helpers import build_resource_url, normalize_identifier


class TelegramClient:
    """Thin client that prepares low-level payloads for Telegram."""
    ...
    def get_profile(self, request: GetProfileRequest) -> dict[str, object]:
        ...
        return {
            "id": identifier,
            "url": build_resource_url(self.settings.website_url, "chat", identifier),
            "label": f"Telegram Chat {identifier}",
        ...
        return [
            {
                ...
                "label": f"Telegram Message {index}",
    ...
    def get_post_detail(self, request: GetPostDetailRequest) -> dict[str, object]:
        ...
        return {
            ...
            "label": f"Telegram Message {content_id}",
    ...
    def publish_content(self, request: PublishContentRequest) -> dict[str, object]:
        ...
        return {
            ...
            "label": request.title or f"Telegram Draft",

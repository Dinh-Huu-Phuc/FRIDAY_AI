...
export function ChatPanel({ messages, loading }: ChatPanelProps) {
  if (loading) {
    return (
      <div className="flex min-h-[520px] items-center justify-center rounded-2xl border border-white/10 bg-white/[0.03] text-sm text-zinc-400">
  ...
  return (
    <ScrollArea className="h-[520px] rounded-2xl border border-white/10 bg-white/[0.03]">

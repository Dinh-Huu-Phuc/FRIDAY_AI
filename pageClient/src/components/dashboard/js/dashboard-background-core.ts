...
export function createDashboardBackgroundCore(canvas: HTMLCanvasElement): DashboardBackgroundCore {
  ...
  const worldGrid = new THREE.GridHelper(6000, 360, 0x00f5ff, 0x0a3340)
  ...
  const nearGrid = new THREE.GridHelper(1600, 160, 0x00f5ff, 0x11505a)
  ...
  const floorGrids = [
    new THREE.GridHelper(900, 120, 0x00f5ff, 0x123f48),
    new THREE.GridHelper(900, 120, 0x00f5ff, 0x123f48),
    new THREE.GridHelper(1200, 150, 0xff2b3d, 0x2d1522),
    new THREE.GridHelper(1200, 150, 0xffb83d, 0x33200d),
    new THREE.GridHelper(1400, 170, 0x00f5ff, 0x0a2d36),
  ]
  ...
  const ceilingGrid = new THREE.GridHelper(3000, 180, 0x00f5ff, 0x082b33)
  ...
  const leftWall = new THREE.GridHelper(2600, 130, 0x00f5ff, 0x08333d)
  ...
  const starCount = window.innerWidth < 720 ? 2200 : 5200
